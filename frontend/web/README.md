...
- `lib/audio-settings.ts` — speed/volume/pitch types, ranges, defaults, and the `useAudioSettings()` localStorage-backed hook. Used by `components/AudioSettingsSheet.tsx` and the TTS create page.
