...
**Summary**: 9 of 19 fully defined, 6 partially, 4 not started. None of the remaining rows block writing the backend skeleton (providers/registry/job submit+poll) — they block specific features (real top-up, a full admin UI, push notifications) that get built after the skeleton runs end-to-end.
